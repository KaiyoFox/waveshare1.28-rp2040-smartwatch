...
void watchFaceAnalog() {
  ...
  int second_x = 120 - (115 * sin(((seconds / 166.666666666) + 180) * PI / 180));
  int second_y = 120 + (115 * cos(((seconds / 166.666666666) + 180) * PI / 180));
  ...
  Paint_DrawLine(120, 120, (uint16_t)hour_x, (uint16_t)hour_y, deviceMainColorTheme, DOT_PIXEL_4X4, LINE_STYLE_SOLID);  // Replace 0x00796F with your chosen color
  Paint_DrawLine(120, 120, (uint16_t)minute_x, (uint16_t)minute_y, deviceSecondColorTheme, DOT_PIXEL_4X4, LINE_STYLE_SOLID);
  ...
  for (int i = 0; i < 12; ++i) {
    uint16_t hour_x_tic = 120 + (93 * sin(((i % 12) * 30 + 0) * PI / 180));
    uint16_t hour_y_tic = 120 - (93 * cos(((i % 12) * 30 + 0) * PI / 180));

    uint16_t hour_x_tic_short = 120 + (95 * sin(((i % 12) * 30 + 0) * PI / 180));
    uint16_t hour_y_tic_short = 120 - (95 * cos(((i % 12) * 30 + 0) * PI / 180));
  ...
  if (runningAppName != "home") {
    Paint_DrawCircle(second_x, second_y, 7, deviceThirdColorTheme, DOT_PIXEL_3X3, DRAW_FILL_FULL);
  }
