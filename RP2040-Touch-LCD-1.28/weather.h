...
void weather(){
    ...
    } else if(weatherDesc == "Rainy" || weatherDesc=="Patchy rain possible" || weatherDesc=="Light rain shower" || 
            weatherDesc=="Patchy light rain with thunder" || weatherDesc=="Moderate or heavy rain shower" || 
            weatherDesc=="Torrential rain shower" || weatherDesc=="Patchy light drizzle" || weatherDesc=="Light drizzle" || 
            weatherDesc=="Patchy light rain" || weatherDesc=="Light rain" || weatherDesc=="Moderate rain at times" || 
            weatherDesc=="Moderate rain" || weatherDesc=="Heavy rain at times" || weatherDesc=="Heavy rain" || 
